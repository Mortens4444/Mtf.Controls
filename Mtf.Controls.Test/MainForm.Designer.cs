...
namespace Mtf.Controls.Test
{
    partial class MainForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            var listViewItem11 = new ListViewItem(new string[] { "Lorem", "1", "2020.10.21" }, -1);
            var listViewItem12 = new ListViewItem(new string[] { "Ipsum", "", "2020.10.21" }, -1);
            var listViewItem13 = new ListViewItem(new string[] { "Dolor", "2", "2020.10.21" }, -1);
            var listViewItem14 = new ListViewItem(new string[] { "Est", "", "" }, -1);
            var listViewItem15 = new ListViewItem(new string[] { "Sit", "", "2020.10.21" }, -1);
            var listViewItem16 = new ListViewItem(new string[] { "Amet", "5", "2020.10.21" }, -1);
            ...
            var listViewItem17 = new ListViewItem(new string[] { "..", "Parent Directory" }, "up");
            ...
            var listViewItem18 = new ListViewItem("2");
            var listViewItem19 = new ListViewItem("3");
            ...
            mtfListView1.Items.AddRange(new ListViewItem[] { listViewItem11, listViewItem12, listViewItem13, listViewItem14, listViewItem15, listViewItem16 });
            ...
            listViewItem17.Tag = "up";
            fileBrowserView1.Items.AddRange(new ListViewItem[] { listViewItem17 });
            ...
            mtfListView2.Items.AddRange(new ListViewItem[] { listViewItem7, listViewItem18, listViewItem19 });
